...
let VideoService = class VideoService {
    ...
    async byId(id, isPublic = false) {
        ...
        if (!video)
            throw new common_1.NotFoundException('Ахтунг видео нот фаунд!');
        return video;
    }
    async update(id, dto) {
        const video = await this.byId(id);
        return this.videoRepository.save(Object.assign(Object.assign({}, video), dto));
    }
